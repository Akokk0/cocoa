                ...
                <TabsContent value="account">
                    <Card>
                        ...
                        <CardContent className="space-y-2">
                            <div className="w-44 h-44 object-cover object-center">
                                {
                                    qrcodeUrl ?
                                        <img
                                            src={qrcodeUrl}
                            ...
                            <div className="text-base h-[1.5rem] w-full">{loginStatus ? <span>{loginStatus}</span> : <span>&nbsp;</span>}</div>
                        </CardContent>
                        <CardFooter>
                            <Button onClick={generateQRCode} className="text-white">生成二维码</Button>
                        </CardFooter>
                    </Card>
                </TabsContent>
